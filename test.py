...
def time_check_and_delete():
    t_now = datetime.now()
    t_range_max = t_now.replace(hour=9, minute=45, second=0, microsecond=0)
...
# # < 30000
# list_result0 = [[['지제역더샵센트럴시티', '64.9', '2억 8,500', '2억 8,500', '중/22', '저렴한전세v답답함없는 뻥뷰v이마트학교근접'], ['지제역더샵센트럴시티', '84.9', '3억      ', '3억      ', ' 4/25', '시에4대, 중문, 줄눈, 탄성, 이보다더저렴할순없다. 꼭 잡으세요']], [['힐스테이트지제역', '59.9', '2억 6,000', '2억 6,000', '고/27', '1년 단기 전세, 옵션X, 초품, 지제역세권']], [['더샵지제역센트럴파크(2BL)', '59.6', '2억 7,000', '2억 7,000', ' 2/26', 'vv필로티 초등학교 가까운동vv'], ['더샵지제역센트럴파크(2BL)', '59.7', '2 억 7,000', '2억 7,000', ' 2/27', '귀한 필로티층,7월말협의입주,커뮤니티센타 가까워요']], [['더샵지제역센트럴파크(1BL)', '59.6', '2억 8,000', '2억 8,000', '중/27', '초등인접 입주가능'], ['더샵지제역센트럴파크(1BL)', '59.7', '2억 7,000', '2억 7,000', '저/25', '에어컨2대, 8월초협의입주가능, 앞이 확트인뷰로 일조권 조망권 최상'], ['더샵지제역센트럴파크(1BL)', '74.9', '3억      ', '3억      ', '고/23', '시스템에어컨4대 영구조망 집상태최상 협의입주']], [['더샵지제역센트럴파크(3BL)', '59.6', '2억 9,000', '2억 9,000', '고/23', '정남향, 로얄층, 단지뷰, 6월 입주 협의 가능'], ['더샵지제역센트럴파크(3BL)', '59.7', '2억 9,000', '2억 9,000', '저/27', '6월중순입주가능 귀한전세 보증금 조절가능'], ['더샵지제역센트럴파크(3BL)', '74.9', '2억 8,000', '2억 8,000', ' 1/21', '현관중문,안방중문,아이들 키우기좋은 1층,현관쪽 펜트리 선호하는구조']], [['힐스테이 트평택', '64.2', '2억 8,000', '2억 8,000', '중/18', '협의입주가.집상태 최상.밝은남향집.뷰좋음'], ['힐스테이트평택', '73.5', '3억      ', '3억      ', '저/23', '방4개.융 자무.햇살이 좋은 뻥뚫린 뷰.'], ['힐스테이트평택', '84.8', '3억      ', '3억      ', '중/28', '바로입주가.완전저렴.끝장뷰.최상의집상태']], [['힐스테이트평택2차', '64.2', '2억 7,000', '2억 7,000', '고/25', '전세대출가능 햇살좋은집입니다 '], ['힐스테이트평택2차', '64.9', '3억      ', '3억      ', '고/21', '공원조망권 조용한동'], ['힐스테이트평택2차', '84.8', '2억 7,000', '2억 7,000', '14/23', '줄눈 탄성상태 시스템에어컨시공협의 5월초이전 입주가능 ']], [['힐스테이트평택3차', '73.4', '3억      ', '3억      ', ' 3/27', '초등학교옆,안정적인층,4월입주']]]
# # < 30000 subtract something
# list_result1 = [[['지제역더샵센트럴시티', '64.9', '2억 8,500', '2억 8,500', '중/22', '저렴한전세v답답함없는 뻥뷰v이마트학교근접'], ['지제역더샵센트럴시티', '84.9', '3억      ', '3억      ', ' 4/25', '시에4대, 중문, 줄눈, 탄성, 이보다더저렴할순없다. 꼭 잡으세요']], [['힐스테이트지제역', '59.9', '2억 6,000', '2억 6,000', '고/27', '1년 단기 전세, 옵션X, 초품, 지제역세권']], [['더샵지제역센트럴파크(2BL)', '59.6', '2억 7,000', '2억 7,000', ' 2/26', 'vv필로티 초등학교 가까운동vv'], ['더샵지제역센트럴파크(2BL)', '59.7', '2 억 7,000', '2억 7,000', ' 2/27', '귀한 필로티층,7월말협의입주,커뮤니티센타 가까워요']], [['더샵지제역센트럴파크(1BL)', '59.6', '2억 8,000', '2억 8,000', '중/27', '초등인접 입주가능'], ['더샵지제역센트럴파크(1BL)', '59.7', '2억 7,000', '2억 7,000', '저/25', '에어컨2대, 8월초협의입주가능, 앞이 확트인뷰로 일조권 조망권 최상'], ['더샵지제역센트럴파크(1BL)', '74.9', '3억      ', '3억      ', '고/23', '시스템에어컨4대 영구조망 집상태최상 협의입주']], [['더샵지제역센트럴파크(3BL)', '59.6', '2억 9,000', '2억 9,000', '고/23', '정남향, 로얄층, 단지뷰, 6월 입주 협의 가능'], ['더샵지제역센트럴파크(3BL)', '59.7', '2억 9,000', '2억 9,000', '저/27', '6월중순입주가능 귀한전세 보증금 조절가능'], ['더샵지제역센트럴파크(3BL)', '74.9', '2억 8,000', '2억 8,000', ' 1/21', '현관중문,안방중문,아이들 키우기좋은 1층,현관쪽 펜트리 선호하는구조']], [['힐스테이 트평택', '64.2', '2억 8,000', '2억 8,000', '중/18', '협의입주가.집상태 최상.밝은남향집.뷰좋음'], ['힐스테이트평택', '73.5', '3억      ', '3억      ', '저/23', '방4개.융 자무.햇살이 좋은 뻥뚫린 뷰.'], ['힐스테이트평택', '84.8', '3억      ', '3억      ', '중/28', '바로입주가.완전저렴.끝장뷰.최상의집상태']], [['힐스테이트평택2차', '64.2', '2억 7,000', '2억 7,000', '고/25', '전세대출가능 햇살좋은집입니다 '], ['힐스테이트평택2차', '64.9', '3억      ', '3억      ', '고/21', '공원조망권 조용한동'], ['힐스테이트평택2차', '84.8', '2억 7,000', '2억 7,000', '14/23', '줄눈 탄성상태 시스템에어컨시공협의 5월초이전 입주가능 ']], [['힐스테이트평택3차', '73.4', '3억      ', '3억      ', ' 3/27', '초등학교옆,안정적인층,4월입주']]]
# # list_result = [[['동탄역동원로얄듀크비스타3차', '47.8', '3억      ', '3억      ', '22/32', '투 룸, 귀한 전세,고층 남서향 밝은 집,공원 뷰']]]

# with open ('data_3', 'wb') as fp:
#     pickle.dump(list_result0, fp)

# with open ('data_3', 'rb') as fp:
#     former = pickle.load(fp)
#     if former == list_result1:
#         print("True")
#     else:
#         print("False")

# if list_result0 == list_result1:
#     print("True")
# else:
#     print("False")
